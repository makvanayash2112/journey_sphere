    ...
    <div class="container">
      <div class="row g-5">
        ...
        <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
          ...
          <h1 class="mb-4">
            Welcome to <span class="text-primary">JourneySphere</span>
          </h1>
          <p class="mb-4">
            Welcome to JourneySphere
            , where your journey is our passion. We are more than just a
            travel agency—we are your dedicated partner in crafting
            unforgettable experiences that will inspire and enrich your life.
            With years of expertise in the travel industry, we specialize in
            curating personalized travel itineraries that cater to the diverse
            interests and desires of our clients.
          </p>
          <p class="mb-4">
            "Our Mission"
            At JourneySphere
            , our mission is to transform your travel dreams into reality.
            Whether you seek the thrill of adventure, the serenity of a beach
            retreat, or the cultural richness of exploring new lands, we
            ensure that every aspect of your journey is meticulously planned
            and flawlessly executed. We believe that travel is not just about
            reaching a destination; it's about the memories you create along
            the way.
          </p>
          ...
          <a class="btn btn-primary py-3 px-5 mt-2" href="contact.php">More
            Details</a>
        </div>
      </div>
    </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-floating">
                        <input
                          ...
                          id="email"
                          placeholder="Your Email" />
                        <label for="email" style="color: white">Destination</label>
                      </div>
                    </div>
                    <div class="col-12">
                      <div class="form-floating">
          ...
          <div class="row gy-5 gx-4 justify-content-center">
            <div
              ...
              <div
                ...
                <p class="mb-0">
                  Explore a world of endless possibilities and find your
                  ideal
                  getaway with just a few clicks. Whether you're dreaming of
                  pristine beaches, vibrant cityscapes, serene mountains, or
                  rich
                  cultural experiences, we have a destination that's perfect
                  for
                  you.
                </p>
              </div>
            ...
            <div
              ...
              <div
                ...
                <hr class="w-50 mx-auto bg-primary mt-0" />
                <p class="mb-0"></p>
                Take the next step towards your adventure. Pay online now
                and
                start looking forward to your unforgettable travel
                experience! if
                you have any questions or need help with the payment
                process, our
            ...
            <div
              ...
              <div
                ...
                <hr class="w-50 mx-auto bg-primary mt-0" />
                <p class="mb-0">
                  With our "Fly Today" options, you can embark on an
                  incredible
                  journey at a moment’s notice. Whether it’s a quick getaway
                  or a
                  spontaneous adventure, we’ve got you covered with flight
                  options
                  that fit your immediate travel needs.
                </p>
              </div>
            </div>
          </div>
