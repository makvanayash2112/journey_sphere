    ...
    <div class="container py-5">
      <div class="row g-5">
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <p class="mb-2">
            <i class="fa fa-map-marker-alt me-3"></i>Atmiya University
            "Yogidham Gurukul, Kalavad Rd, Maruti Nagar, Nana Mava,
            Rajkot, Gujarat 360005
          </p>
          <p class="mb-2">
            <i class="fa fa-phone-alt me-3"></i>+91 9104535808
          </p>
          <p class="mb-2">
            <i class="fa fa-envelope me-3"></i>admin@atmiyauni.ac.in
          </p>
          <div class="d-flex pt-2">
            <a class="btn btn-outline-light btn-social"
              href="https://x.com/?lang=en"><i
                class="bi bi-twitter-x"><svg
        ...
        <div class="row">
          <div
            ...
            &copy; <a class="border-bottom"
              href="#">JourneySphere</a>, All
            Right Reserved.

            <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
            Designed By
            <a class="border-bottom"
              href="https://htmlcodex.com">Tech - Supporters</a>
          </div>
        </div>
      </div>
    </div>
