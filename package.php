      ...
      <div class="row g-4 justify-content-center">
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
          <div class="package-item">
            ...
            <div class="d-flex border-bottom">
              <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-primary me-2"></i>Udaipur</small>
            ...
            <div class="text-center p-4">
              ...
              <p>
                ...
                Flights Charges : Included in Packages.
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
          <div class="package-item">
            ...
            <div class="d-flex border-bottom">
              <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-primary me-2"></i>Kerala</small>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
          <div class="package-item">
            ...
            <div class="d-flex border-bottom">
              <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-primary me-2"></i>Punjab</small>
              <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-primary me-2"></i>5
                days</small>
              <small class="flex-fill text-center py-2"><i class="fa fa-user text-primary me-2"></i>2 Person</small>
            </div>
        ...
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
          <div class="package-item">
            ...
            <div class="d-flex border-bottom">
              <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-primary me-2"></i>Srilanka</small>
              <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-primary me-2"></i>5
                days</small>
              <small class="flex-fill text-center py-2"><i class="fa fa-user text-primary me-2"></i>2 Person</small>
            </div>
      ...
      <div class="row gy-5 gx-4 justify-content-center">
        <div
          ...
          <div class="position-relative border border-primary pt-5 pb-4 px-4">
            ...
            <p class="mb-0">
              Explore a world of endless possibilities and find your ideal
              getaway with just a few clicks. Whether you're dreaming of
              pristine beaches, vibrant cityscapes, serene mountains, or rich
              cultural experiences, we have a destination that's perfect for
              you.
            </p>
          </div>
        </div>
        <div
          ...
          <div class="position-relative border border-primary pt-5 pb-4 px-4">
            ...
            <hr class="w-50 mx-auto bg-primary mt-0" />
            <p class="mb-0"></p>
            Take the next step towards your adventure. Pay online now and
            start looking forward to your unforgettable travel experience! if
            you have any questions or need help with the payment process, our
        ...
        <div
          ...
          <div class="position-relative border border-primary pt-5 pb-4 px-4">
            ...
            <hr class="w-50 mx-auto bg-primary mt-0" />
            <p class="mb-0">
              With our "Fly Today" options, you can embark on an incredible
              journey at a moment’s notice. Whether it’s a quick getaway or a
              spontaneous adventure, we’ve got you covered with flight options
